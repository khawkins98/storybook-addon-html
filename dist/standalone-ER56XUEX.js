...
var gu = (e, t, r) => (r = e != null ? Fu(mu(e)) : {}, hu(pt(r, "default", { value: e, enumerable: true }) , e));
...
var Pn = Cu((Mt) => {
  ...
  function go(e, t, r = {}) {
    let u = Co(), o = e.split(On), { start: i, end: s, markerLines: a } = ho(t, o, r), c = t.start && typeof t.start.column == "number", D = String(s).length, l = e.split(On, s).slice(i, s).map((F, f) => {
...
var yt = gt;
function ie(e) {
  return { type: N, contents: e };
}
function oe(e, t) {
  return { type: O, contents: t, n: e };
}
function At(e, t = {}) {
  return yt(t.expandedStates), { type: B, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
}
function dr(e) {
...
function hr(e) {
  return { type: k, parts: e };
}
function gr(e, t = "", r = {}) {
  return { type: _, breakContents: e, flatContents: t, groupId: r.groupId };
}
function yr(e, t) {
  return { type: v, contents: e, groupId: t.groupId, negate: t.negate };
}
function Se(e) {
...
function xr(e, t) {
  return e ? { type: S, label: e, contents: t } : t;
}
function Q(e) {
  var t;
  if (!e) return "";
...
async function Ye(e, t) {
  ({ ast: e } = await Gt(e, t));
  let r = /* @__PURE__ */ new Map(), n = new Or(e), o = /* @__PURE__ */ new Map();
  await Ln(n, s, t, Ye, o);
...
export { ui as __debug, ri as check, xf as default, qt as doc, fu as format, cu as formatWithCursor, ni as getSupportInfo, Qt as util, tu as version };
